                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title ms-5" id="devicereturnModalLabel">Add Device Order Data
                            </h5>
                                ...
                                <div class="row px-5">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            ...
                                            <select onClick={handleItem} class="form-select" aria-label="Default select example" ref={itemRef}>
                                                <option selected>Select Option</option>
                                                <option value="Device">Device</option>
                                                <option value="Sim Card">Sim Card</option>
                                                <option value="Device+Sim Card">Device+Sim Card</option>
                                ...
                                {item &&
                                    <div class="row px-5">
                                        <div class="col-12 col-md-12 col-lg-12">
                                            <div class="mb-3 text-start">
                                                <label f class="form-label">Other</label>
                                                <input type="type" class="form-control" placeholder='Other item write here' required />
                                            </div>
                                        </div>
                                    </div>
                                }
                                ...
                                {isFile &&
                                    <div class="px-5">
                                        <div style={{ position: "relative", marginBottom: '70px' }}  >
                                            ...
                                            <div>
                                                <button onClick={addFile} className={drStyle.addBtn} type='button'>ADD</button>
                                            </div>
                                        </div>
                                    </div>
                                }
