...
// import scrStyle from './ServiceCarrier.module.css';
function SimCardOrdrForm() {
    // NOTE 
    ...
    return (
        <form action="">
            <div className={scrStyle.simreturnData} class="my-5 mx-5">
                <div class="d-flex justify-content-between px-4">
                    <h3>Sim Card Order</h3>
                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#simorderModal">Add Sim Card Order</button>
                </div>
                    ...
                    <table className={scrStyle.Table}>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#viewsimorderModal">View</button>
                                        <button>Edit</button>
            ...
            <div class="modal fade w-100" id="simorderModal" tabindex="-1" aria-labelledby="simorderModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title ms-5" id="simorderModalLabel">Add Sim Card Order Data
                            </h5>
                        ...
                        <div class="modal-body">
                            <div style={{ fontFamily: 'sans-serif' }}>
                                <div class="row px-5">
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            <label f class="form-label"> Sim Order Number</label>
                                            <input type="text" class="form-control" placeholder=" Order Number" required />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            <label f class="form-label"  >Order Date</label>
                                ...
                                <div class="row px-5">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            <label f class="form-label"> vendor</label>
                                            <input type="number" class="form-control" placeholder="vendor" required />
                                        </div>
                                    </div>
                                ...
                                <div class="row px-5">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            <label f class="form-label"> Batch Number</label>
                                ...
                                <div class="row px-5">
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            <label f class="form-label"> Received Date</label>
                                ...
                                {isNote &&
                                    <div class="px-5">
                                        <div style={{ position: "relative", marginBottom: '70px' }}  >
                                            ...
                                            <div>
                                                <button onClick={addNote} className={scrStyle.addBtn} type='button'>ADD</button>
                                            </div>
                                        </div>
                                    </div>
                                }
                                    ...
                                    <div class="px-5">
                                        <div style={{ position: "relative", marginBottom: '70px' }}  >
                                            <div class=" mb-3">
                                                ...
                                                <input class="form-control" type="file" id="formFile" ref={fileRef} multiple />
                                            </div>
                                            <div>
                                                <button onClick={addFile} className={scrStyle.addBtn} type='button'>ADD</button>
                                            </div>
                                        </div>
                                    </div>
                                }
                                ...
                                <div style={{ marginTop: '50px' }} class="col-12 text-center">
                                    <button class="btn btn-primary" type="submit">Add Device Order</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {/* start  */}
            <div class="modal fade w-100" id="viewsimorderModal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="viewModalLabel">Sim Card Order Data
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div style={{ width: '100%' }} className={scrStyle.serviceView}>
                                ...
                                <div className={scrStyle.button}>
                                    <button className={scrStyle.downloadBtn}><i class="fa fa-download" download></i> Download</button>
                                    <button className={scrStyle.printBtn}><i class="fa fa-print" download></i> Print</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default SimCardOrdrForm