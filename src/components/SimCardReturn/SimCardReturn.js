...
// import srStyle from './ServiceCarrier.module.css';
function SimReturnForm() {
    // NOTE 
    ...
    return (
        <form action="">
            <div className={srStyle.simreturnData} class="my-5 mx-5">
                <div class="d-flex justify-content-between px-4">
                    <h3>Sim Card Returns</h3>
                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#simreturnModal">Add New Vendor</button>
                </div>
                    ...
                    <table className={srStyle.Table}>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#viewsimreturnModal">View</button>
                                        <button>Edit</button>
            ...
            <div class="modal fade w-100" id="simreturnModal" tabindex="-1" aria-labelledby="simreturnModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title ms-5" id="simreturnModalLabel">Add Sim Card Return Data
                            </h5>
                        ...
                        <div class="modal-body">
                            <div style={{ fontFamily: 'sans-serif' }}>
                                <div class="row px-5">
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            <label f class="form-label"  >ID</label>
                                            <input type="number" class="form-control" placeholder="ID" required />
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            <label f class="form-label"> Return Reason</label>
                                ...
                                <div class="row px-5">
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            <label f class="form-label">Return Date </label>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="mb-3 text-start">
                                            ...
                                            <input type="number" class="form-control" placeholder="Item" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="row px-5">
                                ...
                                {isNote &&
                                    <div class="px-5">
                                        <div style={{ position: "relative", marginBottom: '70px' }}  >
                                            ...
                                            <div>
                                                <button onClick={addNote} className={srStyle.addBtn} type='button'>ADD</button>
                                            </div>
                                        </div>
                                    </div>
                                }
            ...
            {/* start  */}
            <div class="modal fade w-100" id="viewsimreturnModal" tabindex="-1" aria-labelledby="viewModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="viewModalLabel">Sim Card Return Data
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div style={{ width: '100%' }} className={srStyle.serviceView}>
                                ...
                                <div className={srStyle.button}>
                                    <button className={srStyle.downloadBtn}><i class="fa fa-download" download></i> Download</button>
                                    <button className={srStyle.printBtn}><i class="fa fa-print" download></i> Print</button>
                                </div>
                            </div>
